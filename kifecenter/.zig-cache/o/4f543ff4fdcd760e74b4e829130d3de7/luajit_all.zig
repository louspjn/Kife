...
pub extern fn luaopen_string_buffer(L: ?*lua_State) c_int;
...
pub const luaJIT_profile_callback = ?*const fn (?*anyopaque, ?*lua_State, c_int, c_int) callconv(.c) void;
pub extern fn luaJIT_profile_start(L: ?*lua_State, mode: [*c]const u8, cb: luaJIT_profile_callback, data: ?*anyopaque) void;
pub extern fn luaJIT_profile_stop(L: ?*lua_State) void;
pub extern fn luaJIT_profile_dumpstack(L: ?*lua_State, fmt: [*c]const u8, depth: c_int, len: [*c]usize) [*c]const u8;
pub extern fn luaJIT_version_2_1_1734355927() void;
...
pub inline fn lua_number2str(s: anytype, n: anytype) @TypeOf(sprintf(s, LUA_NUMBER_FMT, n)) {
    _ = &s;
    _ = &n;
...
// .zig-cache/o/b50774243e5256eec6b2ac1a91efcd89/luaconf.h:136:9
pub const LUALIB_API = LUA_API;
pub const luai_apicheck = @compileError("unable to translate C expr: unexpected token '{'");
// .zig-cache/o/b50774243e5256eec6b2ac1a91efcd89/luaconf.h:151:9
...
pub inline fn lua_open() @TypeOf(luaL_newstate()) {
...
pub const LUA_BITLIBNAME = "bit";
pub const LUA_JITLIBNAME = "jit";
pub const LUA_FFILIBNAME = "ffi";
...
// .zig-cache/o/b50774243e5256eec6b2ac1a91efcd89/lauxlib.h:123:9
...
// .zig-cache/o/b50774243e5256eec6b2ac1a91efcd89/lauxlib.h:142:9
...
// .zig-cache/o/b50774243e5256eec6b2ac1a91efcd89/lauxlib.h:149:9
pub const _LUAJIT_H = "";
pub const LUAJIT_VERSION = "LuaJIT 2.1.1734355927";
pub const LUAJIT_VERSION_NUM = @as(c_int, 20199);
pub const LUAJIT_VERSION_SYM = luaJIT_version_2_1_1734355927;
pub const LUAJIT_COPYRIGHT = "Copyright (C) 2005-2025 Mike Pall";
pub const LUAJIT_URL = "https://luajit.org/";
pub const LUAJIT_MODE_MASK = @as(c_int, 0x00ff);
pub const LUAJIT_MODE_OFF = @as(c_int, 0x0000);
pub const LUAJIT_MODE_ON = @as(c_int, 0x0100);
pub const LUAJIT_MODE_FLUSH = @as(c_int, 0x0200);
